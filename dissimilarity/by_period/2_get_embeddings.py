...
if __name__ == '__main__':
    ...
    file = os.path.join('by_period', 'data', 'by_date_vocab.pickle')
    with open(file, 'rb') as handle:
        vocab = dill.load(handle)

    dir_path = os.path.join('by_period', 'embeddings')
    embeddings_path = os.path.join(dir_path, 'by_date_vocab.pickle')
