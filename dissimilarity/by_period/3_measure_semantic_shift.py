...
if __name__ == '__main__':
    ...
    calculate_diff = [(0, 1), (2,3), (0,2), (0,3), (1,2), (1,3)]

    embeddings_path = os.path.join('by_period', 'embeddings', 'by_date_vocab.pickle')
    results_dir = os.path.join('by_period', 'results')
