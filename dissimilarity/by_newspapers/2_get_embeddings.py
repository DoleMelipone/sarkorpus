...
if __name__ == '__main__':
    ...
    file = os.path.join('by_newspapers', 'since_2015', 'data', 'by_paper_3_vocab.pickle')
    with open(file, 'rb') as handle:
        vocab = dill.load(handle)

    dir_path = os.path.join('by_newspapers', 'since_2015', 'embeddings')
    embeddings_path = os.path.join(dir_path, 'by_paper_3_vocab.pickle')
