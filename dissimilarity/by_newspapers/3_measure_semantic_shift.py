...
if __name__ == '__main__':
    ...
    calculate_diff = [(0, 1), (0, 2), (1, 2)]

    embeddings_path = os.path.join('by_newspapers', 'since_2015', 'embeddings', 'by_paper_3_vocab.pickle')
    results_dir = os.path.join('by_newspapers', 'since_2015', 'results')
