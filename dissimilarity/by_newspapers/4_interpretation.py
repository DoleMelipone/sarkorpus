...
if __name__ == '__main__':
    ...
    interpretation_folder = os.path.join('by_newspapers', 'since_2015', 'interpretation')
    if not os.path.exists(interpretation_folder):
        os.makedirs(interpretation_folder)

    results_folder = os.path.join('by_newspapers', 'since_2015', 'results')

    corpus_slices = [
        'liberation', 'monde', 'figaro'
    ]
